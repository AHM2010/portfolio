...
export function CrmShowcase() {
  ...
  return (
    <article className="grid overflow-hidden rounded-[30px] bg-[#1b1d18] p-5 text-[#f2f2ec] shadow-soft md:p-10 lg:grid-cols-[.9fr_1.1fr] lg:gap-12 lg:p-12">
      <div>
        <p className="text-xs font-bold uppercase tracking-widest text-[#dbb557]">Flagship case study · In development</p>
        <h3 className="mt-4 font-display text-5xl leading-none">CRM Dashboard</h3>
        ...
        <h4 className="mb-2 mt-7 text-xs font-bold uppercase tracking-widest text-[#dbb557]">Project overview</h4>
        ...
        <ul className="mt-6 grid gap-2 sm:grid-cols-2">
          {features.map((feature) => (
            <li className="flex items-center gap-2 text-xs text-[#c5c7be]" key={feature}>
      ...
      <div className="relative mt-9 aspect-[16/10] self-center overflow-hidden rounded-[20px] border border-[#363a31] bg-[#0d0f0c] shadow-2xl lg:mt-0">
        <Image
          src="/images/nexora-dashboard.png"
          alt="Nexora CRM dashboard showing analytics, deals, and customer activity"
          fill
        ...
        <AnimatePresence initial={false}>
          {detailsOpen && (
            ...
            >
              ...
              >
          <p>
            <b>Problem</b> Customer information, deal progress, and tasks can
            become fragmented across separate tools.
          </p>
          <p>
            <b>Solution</b> A unified, responsive dashboard concept with clear
            navigation and shared interface patterns.
          </p>
          <p>
            <b>What I’m learning</b> Typed application structure, dashboard
            information hierarchy, reusable components, and accessibility.
          </p>
          <p>
            <b>Challenges</b> Keeping dense business data understandable across
            desktop and mobile layouts.
          </p>
          <p>
            <b>Future improvements</b> Complete authentication, connect
            persistent data, add testing, and validate the workflows with users.
          </p>
              </motion.div>
            </motion.div>
          )}
